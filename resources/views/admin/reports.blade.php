...
@section('content')
<div class="container">
  <div class="admin-page-title"><div><p class="admin-eyebrow">Moderación</p><h1>Reportes</h1><p class="admin-page-subtitle">Revisa incidencias, aplica resoluciones y deja trazabilidad.</p></div></div>
